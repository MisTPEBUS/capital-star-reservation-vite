    ...
    items: [
      {
        question: "如何完成預約？",
        answer:
          "請依序選擇上車站、乘車日期及班次，確認資料後送出預約。預約成功後會顯示乘車憑證。",
      },
      {
        question: "可以預約兩個班次嗎？",
        answer:
          "不可以。每位使用者只能有一筆有效預約；若已有預約，系統會提示您已有預約。",
      },
      {
        question: "我已預約明天的班次，還可以預約後天嗎？",
        answer:
          "不可以。系統限制同帳號只能有一筆有效預約，請於班次搭乘後再行預約。",
      },
      {
        question: "我可以替其他人(多人)一起預約嗎？",
        answer:
          "不可以。同帳號僅能預約一筆一人，如有其他需求，請當日來電各轉運站預約。",
      },
      {
        question: "櫃台可以替沒有 LINE 帳號的乘客預約嗎？",
        answer: "可以。櫃台接受當日電話預約。",
      },
      {
    ...
    items: [
      {
        question: "如何確認預約是否成功？",
        answer:
          "預約成功後，系統會顯示乘車序號及乘車憑證。您也可以在右上角「近期預約紀錄」中查看班次日期、發車時間及上車站。",
      },
      {
